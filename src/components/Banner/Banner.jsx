    ...
    return (
        <div className='flex flex-col md:flex-row gap-5 items-center justify-between mt-5'>
            <div>
                ...
                <p className='md:text-lg mt-1 md:mt-3 max-w-2xl'>Transforming visions into captivating web interfaces with mastery in HTML, CSS, and JavaScript. Also expertly weaving MongoDB, Express.js, React.js, and Node.js into seamless, scalable applications.</p>
                <div className='flex gap-5 mt-4 md:mt-6'>
                    <button className='btn btn-ghost text-white hover:text-black bg-[#219C90]'>Download Resume</button>
                    <button className='btn btn-ghost text-white hover:text-black bg-[#219C90]'>Contact Me</button>
                </div>
            </div>
            <div>
